...
{
    public class ServicesVzLaCantvDataResponse
    {
        //  [Key]
        ...
        //[Index("CantvData_UserId_CodePhone_NumberPhone_Index", IsUnique = true, Order = 1)]
        ...
        //[Index("CantvData_UserId_CodePhone_NumberPhone_Index", IsUnique = true, Order = 2)]
        ...
        //[RegularExpression(@"[0-9]{1,9}(\.[0-9]{0,2})?$", ErrorMessage = "The field {0} only can contains value numerics...!!!")]
        //[Index("CantvData_UserId_CodePhone_NumberPhone_Index", IsUnique = true, Order = 3)]
